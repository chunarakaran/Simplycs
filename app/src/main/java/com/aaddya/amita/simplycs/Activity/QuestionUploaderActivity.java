...
//                progressBar.setVisibility(View.GONE);
            ...
            public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(QuestionUploaderActivity.this);
...
//                progressBar.setVisibility(View.GONE);
    ...
    private class myChrome extends WebChromeClient {
        ...
        public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) {
            ...
            if (takePictureIntent.resolveActivity(QuestionUploaderActivity.this.getPackageManager()) != null) {
                File photoFile = null;
                try {
    ...
    public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
        ...
        i.setType("*/*");
        QuestionUploaderActivity.this.startActivityForResult(Intent.createChooser(i, "File Browser"), FILECHOOSER_RESULTCODE);
    }
