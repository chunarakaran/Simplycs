...
public class PDFListRecyclerViewAdapter extends RecyclerView.Adapter<PDFListRecyclerViewAdapter.ViewHolder> {
    ...
    List<PDFListDataAdapter> dataAdapters;


    public PDFListRecyclerViewAdapter(List<PDFListDataAdapter> getDataAdapter, Context context){
    ...
    public void onBindViewHolder(ViewHolder Viewholder, int position) {
        ...
        PDFListDataAdapter dataAdapterOBJ =  dataAdapters.get(position);
